...
--
-- Host: localhost
-- Generation Time: May 02, 2018 at 07:53 AM
...
--
-- Dumping data for table `catatan_mutu`
--

INSERT INTO `catatan_mutu` (`id_catatan`, `judul`, `id_status_cm`, `masa_berlaku`, `lokasi_simpan`, `file`, `keterangan`, `entry_date`, `id_metode`, `id_admin`) VALUES
(2, 'support_document_1', 1, '2018-04-30', 'a', 'IMG_0185.JPG', NULL, '2018-04-27 00:00:00', 2, 9);
...
INSERT INTO `internal` (`id`, `id_dokumen`, `id_catatan`) VALUES
(2, 2, 2);
...
(9, 'Muhammad Ibnu Fahmi', 2, 'ibnu', 'cfbf93fa3850e562afabae584ae850e935e18ba1', '2018-04-16 00:00:00', 1);
...
--
-- Dumping data for table `tb_dokumen_baru`
--

INSERT INTO `tb_dokumen_baru` (`id_dokumen`, `kode`, `nama_dokumen`, `id_jenis_dokumen`, `keterangan`, `id_revisi`, `file`, `id_status_dokumen`, `entry_date`, `id_admin`) VALUES
(2, 'Belum Disertai', 'sample  2', 4, '', 2, 'Assignment_-_Literature_Review_Part_04.docx', 1, '2018-04-30', 9);
...
INSERT INTO `tb_peraturan` (`id_peraturan`, `id_instansi`, `judul`, `tahun`, `id_regulator`, `file`, `entry_date`, `masa_berlaku`, `id_admin`) VALUES
(1, 2, 'PP No. X 1992', 1992, 3, 'Assignment_-_Literature_Review_Part_041.docx', '2018-04-30', '2018-06-01', 1);
...
--
ALTER TABLE `catatan_mutu`
  MODIFY `id_catatan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `regulator`
  MODIFY `id_regulator` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_peraturan`
  MODIFY `id_peraturan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
