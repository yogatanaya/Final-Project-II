<div id="page-wrapper">
     ...
     <!-- /.row -->
        <div class="row">
             <form class="form-inline" action="<?php echo base_url('admin/addRegulator')?>" method="post" enctype="multipart/form-data" role="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul style="list-style-type: none;">
                                    <li><a href="<?php echo base_url('admin/hapusRegulator/'.$r['id_regulator']);?>" class="glyphicon glyphicon-remove" onclick="return confirm('Anda akan menghapus regulator ini?');"></a>
                                 </li>
                            </ul>            
