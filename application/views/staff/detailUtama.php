<div id="page-wrapper">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                <div class="page-body">
                    <form class="form-inline" action="<?php echo base_url('staff/addDetail')?>" method="post" enctype="multipart/form-data" role="form" name="addDetail" id="addDetail">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul style="list-style-type: none;">
                                 <li><a href="<?php echo base_url('staff/hapusTautan/'.$d['id']);?>" class="glyphicon glyphicon-remove" onclick="return confirm('Anda akan menghapus Tautan ini?');"></a>
                                 </li>
                            </ul>
                        </td>
                    </tr>
