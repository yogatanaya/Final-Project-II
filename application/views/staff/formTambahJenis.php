<div id="page-wrapper">
     ...
     <!-- /.row -->
        <div class="row">
             <form class="form-inline" action="<?php echo base_url('staff/addJenis')?>" method="post" enctype="multipart/form-data" role="form">
         ...
         <table width="100%" class="table">
                <thead>
                    <tr>
                        ...
                        <th data-field="kode">Jenis Dokumen</th>
                        <th colspan="1">Aksi</th>                         
                    </tr>
                </thead>
                <tbody>
                    <?php $no=1;
                    foreach ($tb_jenis_dokumen as $j) { ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
